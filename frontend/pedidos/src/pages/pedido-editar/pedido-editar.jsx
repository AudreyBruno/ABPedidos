...
function PedidoEditar(){
    ...
    const [vl_total, setVlTotal] = useState("");
    ...
    function CarregarDadosPedido(id_ped){
        if (id_ped > 0){
            ...
            .then((retorno) => {
                ...
                setNomeCliente(retorno.data.nome_cliente);
        ...
        <div className="container-fluid mt-page form-pedido-editar">
            ...
            <div className="row col-lg-6 offset-lg-3">
                ...
                <div className="col-md-8 mb-4">
                    ...
                    <AutocompleteCliente placeholder="Pesquisar cliente..." onClickId={setIdCliente} onClickNome={setNomeCliente} value={nome_cliente} />                 
                </div>
