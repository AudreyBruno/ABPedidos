                ...
                <div className="autocomplete-items">
                    {
                        lista_clientes.map((cli) => {
                            return <div key={cli.id_cliente} className="autocomplete-item" onClick={(e) => SelecionarItem(cli.id_cliente, cli.nome)}>
                                    <b>{cli.nome}</b><br/>
                                    <small className="text-secondary">Código: {cli.id_cliente}</small><br/>                                    
                            </div>
                        })
                    }
                </div>
